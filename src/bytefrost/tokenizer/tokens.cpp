...
const std::string& tokenTypeToString(TokenType type) {
	static const std::unordered_map<TokenType, std::string> map = {
		...
		{TokenType::I8, "I8"}, {TokenType::I16, "I16"}, {TokenType::I32, "I32"}, {TokenType::I64, "I64"}, {TokenType::I128, "I128"},
		{TokenType::U8, "U8"}, {TokenType::U16, "U16"}, {TokenType::U32, "U32"}, {TokenType::U64, "U64"}, {TokenType::U128, "U128"},
		{TokenType::ISIZE, "ISIZE"}, {TokenType::USIZE, "USIZE"},
		// Keywords - float types
		{TokenType::F16, "F16"}, {TokenType::F32, "F32"}, {TokenType::F64, "F64"}, {TokenType::F128, "F128"},
...
std::string Token::toString() const {
	...
	if (type == TokenType::UNKNOWN) {
		return "UNKNOWN (line: " + std::to_string(line) + ", column: " + std::to_string(column) + ", value: \"" + value + "\")";
	}
