...
const char* tokenTypeToString(TokenType type) {
	switch (type) {
		...
		case TokenType::UNKNOWN_TOKEN:
			return "UNKNOWN";
		case TokenType::INT_LITERAL_TOKEN:
			return "INT_LITERAL";
		case TokenType::FLOAT_LITERAL_TOKEN:
			return "FLOAT_LITERAL";
		case TokenType::STRING_LITERAL_TOKEN:
			return "STRING_LITERAL";
		case TokenType::CHAR_LITERAL_TOKEN:
			return "CHAR_LITERAL";
		case TokenType::IDENTIFIER_TOKEN:
			return "IDENTIFIER";
		case TokenType::INTERP_STRING_START_TOKEN:
			return "INTERP_STRING_START";
		case TokenType::INTERP_STRING_MID_TOKEN:
			return "INTERP_STRING_MID";
		case TokenType::INTERP_STRING_END_TOKEN:
			return "INTERP_STRING_END";
		case TokenType::IF_TOKEN:
			return "IF";
		case TokenType::ELSE_TOKEN:
			return "ELSE";
		case TokenType::ELSEIF_TOKEN:
			return "ELSEIF";
		...
		case TokenType::ARRAY_TOKEN:
			return "ARRAY";
		case TokenType::SLICE_TOKEN:
			return "SLICE";
		case TokenType::MAP_TOKEN:
			return "MAP";
		case TokenType::IMPORT_TOKEN:
			return "IMPORT";
		case TokenType::EXPORT_TOKEN:
			return "EXPORT";
		...
		case TokenType::ASSIGN_TOKEN:
			return "ASSIGN";
		case TokenType::WALRUS_TOKEN:
			return "WALRUS";
		case TokenType::PLUS_ASSIGN_TOKEN:
			return "PLUS_ASSIGN";
		case TokenType::MINUS_ASSIGN_TOKEN:
			return "MINUS_ASSIGN";
		case TokenType::MULTIPLY_ASSIGN_TOKEN:
			return "MULTIPLY_ASSIGN";
		case TokenType::DIVIDE_ASSIGN_TOKEN:
			return "DIVIDE_ASSIGN";
		case TokenType::MODULO_ASSIGN_TOKEN:
		...
		case TokenType::LESS_TOKEN:
			return "LESS";
		case TokenType::LESS_EQUAL_TOKEN:
			return "LESS_EQUAL";
		case TokenType::GREATER_TOKEN:
			return "GREATER";
		case TokenType::GREATER_EQUAL_TOKEN:
		...
		case TokenType::NOT_TOKEN:
			return "NOT";
		case TokenType::XOR_TOKEN:
			return "XOR";
		case TokenType::BIT_AND_TOKEN:
			return "BIT_AND";
		case TokenType::BIT_OR_TOKEN:
			return "BIT_OR";
		case TokenType::BIT_XOR_TOKEN:
			return "BIT_XOR";
		case TokenType::BIT_NOT_TOKEN:
			return "BIT_NOT";
		case TokenType::LEFT_SHIFT_TOKEN:
			return "LEFT_SHIFT";
		case TokenType::RIGHT_SHIFT_TOKEN:
			return "RIGHT_SHIFT";
		...
		case TokenType::RIGHT_PAREN_TOKEN:
			return "RIGHT_PAREN";
		case TokenType::LEFT_BRACE_TOKEN:
			return "LEFT_BRACE";
		case TokenType::RIGHT_BRACE_TOKEN:
			return "RIGHT_BRACE";
		...
		case TokenType::DOT_TOKEN:
			return "DOT";
		case TokenType::ARROW_TOKEN:
			return "ARROW";
		case TokenType::UNDERSCORE_TOKEN:
			return "UNDERSCORE";
